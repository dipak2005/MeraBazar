...
function ProductTile({ product, handleAddToCart, toast,wishList, handleWishlistToggle}) {
 ...
 const { user } = useSelector((state) => state.auth);
  ...
  return (
    ...
    >
      ...
      <Link to={`/product/${product._id}`} className="text-decoration-none text-dark" rel="noopener noreferrer" target="_blank">
        {product?.totalStock === 0 ? (
          ...
          <span className="badge bg-success position-absolute top-0 start-0 m-2">Best Seller</span>
        ) : null}
